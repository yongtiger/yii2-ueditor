...
//        $this->stateMap['ERROR_TYPE_NOT_ALLOWED'] = iconv('unicode', 'utf-8', $this->stateMap['ERROR_TYPE_NOT_ALLOWED']);
    ...
    private function saveRemote()
    {
        ...
        //获取请求头并检测死链
        ///[UEditor_Event][BUG]@see D:\[MY DOCS]\1、【学】搜学思\12.2、【PHP框架：Yii】\3、Yii2开发指南[扩展篇]\UEditor.docx
        ...
        if (!in_array($fileType, $this->config['allowFiles']) || stristr($heads['Content-Type'], "image") === false) {
